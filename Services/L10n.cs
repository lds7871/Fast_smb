...
public class L10n : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["server_label"] = " IP / 主机名",
        ["server_placeholder"] = "例如 192.168.1.100",
        ["share_label"] = "共享名",
        ["share_placeholder"] = "可选，留空自动检测",
        ["user_label"] = "用户名",
        ["user_placeholder"] = "根据服务器规则可留空",
        ["pass_label"] = "密码",
        ["pass_placeholder"] = "密码",
        ["remember"] = "记住输入",
        ["connect_btn"] = "连 接",
        ...
        ["repo_close"] = "关闭",
        ["repo_copied"] = "✓ 已复制到剪贴板",
        ["repo_url"] = "https://github.com/lds7871/Fast_smb",
        ["notes_title"] = "连接注意事项",
        ["notes_gotit"] = "知道了",
        ["notes_text"] =
            "【连接前】\n" +
        ...
        ["delete_confirm_msg"] = "确定要删除选中的 {0} 个项目吗？此操作不可恢复。",
        ["deleting"] = "正在删除",
        ["delete_done"] = "删除完成：",
        ["delete_fail"] = "删除失败：",
        ["delete_err"] = "删除出错：",
        ["delete_not_empty"] = "目录非空，无法删除",
        ["delete_still_exists"] = "文件仍存在，可能被占用或无权限",
        ["select_delete_first"] = "请先选择要删除的项目",
        ["preview_title"] = "预览",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["server_placeholder"] = "e.g. 192.168.1.100 ",
        ["share_label"] = "Share ",
        ["share_placeholder"] = "optional, auto-detect if empty",
        ["user_label"] = "Username",
        ["user_placeholder"] = "It can be left blank according to the server rules",
        ["pass_label"] = "Password",
        ...
        ["lang_en"] = "EN",
        ["repo_btn"] = "Repo",
        ["repo_title"] = "Source Repository",
        ["repo_copy"] = "Copy",
        ["repo_open"] = "Open",
        ["repo_close"] = "Close",
        ["repo_copied"] = "✓ Copied to clipboard",
        ["repo_url"] = "https://github.com/lds7871/Fast_smb",
        ...
        ["delete_confirm_msg"] = "Delete the {0} selected item(s)? This cannot be undone.",
        ["deleting"] = "Deleting",
        ["delete_done"] = "Deleted: ",
        ["delete_fail"] = "Delete failed: ",
        ["delete_err"] = "Delete error: ",
        ["delete_not_empty"] = "Folder is not empty",
        ["delete_still_exists"] = "File still exists (may be in use or no permission)",
        ["select_delete_first"] = "Select items to delete first",
